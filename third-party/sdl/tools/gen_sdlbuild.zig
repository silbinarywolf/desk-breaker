...
pub const SDLBuildGenerator = struct {
    ...
    pub fn generateSDLConfig(g: *@This()) !void {
        ...
        var data = try fs.cwd().readFileAlloc(allocator, try std.fs.path.join(allocator, &.{ g.sdl_dir, "include", "build_config", "SDL_build_config.h.cmake" }), 1_000_000);
    ...
    fn readAndWriteModule(g: *@This(), writer: *std.Io.Writer, dir: std.fs.Dir, moduleName: []const u8, dirPrefix: []const u8) !void {
        const allocator = g.arena_allocator.allocator();
